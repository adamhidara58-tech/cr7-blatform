    ...
    <PageLayout>
        ...
        <div className="relative bg-[#141419] border border-white/5 rounded-[3rem] p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="w-full py-4 px-5 rounded-2xl bg-white/5 border border-white/10 text-center">
                <p className="text-xs text-slate-400 font-extrabold text-center">أدعُ أصدقاء للحصول على دورات إضافية</p>
              </div>
            }
      ...
      <section className="px-4 mb-10">
        <motion.div
          ...
          <div className="bg-black/40 p-4 mb-6 flex items-center justify-between gap-4 border border-white/5 rounded-3xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/5 rounded-2xl p-4 text-center py-0 px-px my-0 border-8 border-[#232329]">
              <p className="mb-1 uppercase font-extrabold text-slate-500 text-sm">كود الدعوة</p>
              <p className="font-black text-gold font-mono tracking-widest text-3xl">{profile.referral_code}</p>
            </div>
        ...
        <motion.div
          ...
          <div className="grid grid-cols-1 gap-4">
            <a
              ...
              className="flex items-center justify-between bg-black/40 p-5 border border-white/5 hover:border-gold/30 transition-all group rounded-3xl">
