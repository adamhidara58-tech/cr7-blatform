  ...
  return (
    <div
      ...
      <div className="px-4 pb-4 pt-2">
          <nav
          className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto pointer-events-auto glass-navbar shadow-[0_-4px_24px_rgba(0,0,0,0.6),0_8px_32px_rgba(0,0,0,0.5)] rounded-full"
          style={{
          ...
          <div className="px-2 h-16 flex-row flex items-start justify-start gap-[10px] rounded-full">
            {NAV_ITEMS.map((item) =>
            <NavButton
              key={item.path}
              item={item}
